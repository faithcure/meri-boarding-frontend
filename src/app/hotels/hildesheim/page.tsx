...
type HildesheimHotelPageProps = {
  params?: { locale?: Locale } | Promise<{ locale?: Locale }>;
};

export default async function HildesheimHotelPage({ params }: HildesheimHotelPageProps = {}) {
  const resolvedParams = await params;
  const locale = resolvedParams?.locale ?? (await getLocale());
  const t = getMessages(locale).hotelDetail.hildesheim;
          ...
          <div className="container">
            <div className="row g-4 gx-5">
              ...
              <div className="col-lg-8">
                <div className="owl-custom-nav menu-float" data-target="#hildesheim-carousel">
                  <a className="btn-next"></a>
                  <a className="btn-prev"></a>

                  <div id="hildesheim-carousel" className="owl-single-static owl-carousel owl-theme">
                    <div className="item">
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Hildesheim boardinghouse living area"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Hildesheim boardinghouse bedroom"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Hildesheim boardinghouse kitchen"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Hildesheim boardinghouse details"
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div className={`col-md-3 col-sm-6 col-12 item ${item.category}`} key={item.src}>
                  <a href={item.src} className="image-popup d-block hover">
                    <div className="relative overflow-hidden rounded-1 media-frame">
                      ...
                      <img src={item.src} className="w-100 hover-scale-1-2" alt={`Hildesheim gallery ${index + 1}`} />
                    </div>
                  </a>
                </div>
              ))}
