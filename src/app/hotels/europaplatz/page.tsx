...
type EuropaplatzHotelPageProps = {
  params?: { locale?: Locale } | Promise<{ locale?: Locale }>;
};

export default async function EuropaplatzHotelPage({ params }: EuropaplatzHotelPageProps = {}) {
  const resolvedParams = await params;
  const locale = resolvedParams?.locale ?? (await getLocale());
  const t = getMessages(locale).hotelDetail.europaplatz;
          ...
          <div className="container">
            <div className="row g-4 gx-5">
              ...
              <div className="col-lg-8">
                <div className="owl-custom-nav menu-float" data-target="#europaplatz-carousel">
                  <a className="btn-next"></a>
                  <a className="btn-prev"></a>

                  <div id="europaplatz-carousel" className="owl-single-static owl-carousel owl-theme">
                    <div className="item">
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Europaplatz boardinghouse living area"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Europaplatz boardinghouse bedroom"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Europaplatz boardinghouse kitchen"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="relative">
                        <div className="overflow-hidden rounded-1 media-frame">
                          <img
                            ...
                            className="w-100"
                            alt="Europaplatz boardinghouse details"
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <ul className="ul-check">
                      {t.highlights.slice(0, 8).map((item) => (
                        <li key={item}>{item}</li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className={`col-md-3 col-sm-6 col-12 item ${item.category}`} key={item.src}>
                  <a href={item.src} className="image-popup d-block hover">
                    <div className="relative overflow-hidden rounded-1 media-frame">
                      ...
                      <img src={item.src} className="w-100 hover-scale-1-2" alt={`Europaplatz gallery ${index + 1}`} />
                    </div>
                  </a>
                </div>
              ))}
