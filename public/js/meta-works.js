 /* --------------------------------------------------
  * © Copyright 2025 - Meri by meta-works
  * --------------------------------------------------*/
(function($) {
    'use strict';
  ...
  new WOW().init();
     ...
     function filterGallery() {
       ...
       $(document).off('click', '#filters a').on('click', '#filters a', function (e) {
         e.preventDefault();
         const $this = $(this);
    ...
    function init() {
     ...
     if (typeof window !== "undefined") {
       window.metaWorksReinit = reinitMetaWorks;
     }
     ...
     const hidePreloader = () => jQuery('#de-loader').fadeOut(500);
    ...
    // text rotatation end
      ...
      * --------------------------------------------------*/
     $(function(){
        if (!$('#de-loader .lds-roller').length) {
